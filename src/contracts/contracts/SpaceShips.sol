...
contract SpaceShips is ERC721URIStorage {
    ...
    function mintShip(address owner) public returns (uint256) {
        ...
        string memory metadataURI = string(abi.encodePacked("https://cosmowar.io/assets/ships/", "0000", ".json"));
    ...
    function upgradeShip(uint256 tokenId, string memory shipCode) public {
        ...
        string memory metadataURI = string(abi.encodePacked("https://cosmowar.io/assets/ships/", shipCode, ".json"));
