...
export class ShopScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.textBalance = this.add.text(40, 20, `MY BALANCE: ${state.spaceCoinsBalance} SPACECOINS`, {
  ...
  update(time: number, delta: number): void {
    if (this.textBalance) this.textBalance.setText(`MY BALANCE: ${state.spaceCoinsBalance} SPACECOINS`)
  }
}
